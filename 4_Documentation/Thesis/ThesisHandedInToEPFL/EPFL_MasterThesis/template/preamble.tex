...
uniquename=false, uniquelist=false, %% prevent first names to appear in case of two authors having the same last name
doi=false,isbn=false,url=false %% removes DOI, ISBN & URL from bibliography
...
%doc% \end{enumerate}
\raggedbottom %prevent spreading of text across page
